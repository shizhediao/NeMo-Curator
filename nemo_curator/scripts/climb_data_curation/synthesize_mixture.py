...
def get_token_distribution():
    ...
    # script 
    train = {
        "train_the_cluster1": 0.113285273,
        "train_the_cluster2": 0.079608651,
        "train_the_cluster3": 0.003913491,
        "train_the_cluster4": 0.185375901,
        "train_the_cluster5": 0.051081359,
        "train_the_cluster6": 0.015962925,
        "train_the_cluster7": 0.101750772,
        "train_the_cluster8": 0.003707518,
        "train_the_cluster9": 0.066529351,
        "train_the_cluster10": 0.001750772,
        "train_the_cluster11": 0.027085479,
    }

    # valid cannot be ignored if you want the generated config is evaluated on the target set
    valid = {
        "valid_the_cluster1": 1.0,
        "valid_the_cluster2": 1.0,
        "valid_the_cluster3": 1.0,
        "valid_the_cluster4": 1.0,
        "valid_the_cluster5": 1.0,
        "valid_the_cluster6": 1.0,
        "valid_the_cluster7": 1.0,
        "valid_the_cluster8": 1.0,
        "valid_the_cluster9": 1.0,
        "valid_the_cluster10": 1.0,
        "valid_the_cluster11": 1.0,
    }
